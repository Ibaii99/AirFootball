 ...
 */
public class Pelota extends ObjetoFisico {
	private double radio;  // Radio de pelota
	
	/** Constructor de pelota por defecto: nombre vac�o, centro (0,0), radio 10, color azul, bota true
	 */
	public Pelota() {
		this( 0, 0, 10, 'a', true );
	}
	...
	/** Constructor de pelota con datos m�nimos, suponiendo color azul y bota = true
	 * @param x	Coordenada x del centro de la pelota
	 * @param y	Coordenada y del centro de la pelota
	 * @param radio	Radio de la pelota
	 */
	public Pelota(double x, double y, double radio) {
		this( x, y, radio, 'a', true );
	}
