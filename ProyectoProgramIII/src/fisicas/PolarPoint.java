...
public class PolarPoint {
	 ...
	 * @param modulo	M�dulo del punto  (debe ser positivo)
	 * @param argumento	Argumento en radianes (�ngulo sobre el eje OX)
	 */
	...
	/** Devuelve el m�dulo que tendr�a este punto polar si la X cartesiana tuviera el valor indicado, con ese mismo argumento
	 * @param x	Valor de x cartesiana
	 * @return	M�dulo que tendr�a. Si el argumento es vertical (90 o 270�), el valor puede ser infinito.
	 */
	public double getModuloParaX( double x ) {
		return Math.abs(x/Math.cos( argumento ));
	}

	/** Devuelve el m�dulo que tendr�a este punto polar si la Y cartesiana tuviera el valor indicado, con ese mismo argumento
	 * @param y	Valor de y cartesiana
	 * @return	M�dulo que tendr�a. Si el argumento es vertical (0 o 180�), el valor puede ser infinito.
	 */
	...
	/** Transforma el punto polar a un nuevo eje de referencia
	 * @param angulo	�ngulo que forma el nuevo eje con respecto al eje OX
	 */
	 ...
	 * @return	Punto polar en coordenadas m�dulo,argumento
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println( "Nuevo eje: " + nuevoEje + " - �ngulo " + Math.atan2( nuevoEje.getY(), nuevoEje.getX() ) );
