...
public class ventanaPartido extends JFrame {
	...
	// graphics.drawOval( (int)Math.round(x-radio), (int)Math.round(y-radio),
	...
	// dibujaLinea( linea.getX1(), linea.getY1(), linea.getX2(), linea.getY2(),
	// grosor, color );
	// }
	//
	// /** Dibuja una l�nea en la ventana
	...
	// * @param color Color de la l�nea
	// */
	// public void dibujaLinea( double x, double y, double x2, double y2, float
	// grosor, Color color ) {
	// graphics.setColor( color );
	// graphics.setStroke( new BasicStroke( grosor ));
	...
	// * @param grosor Grueso de la l�nea (en p�xels)
	// */
	// public void borraLinea( double x, double y, double x2, double y2, float
	// grosor ) {
	...
	// dibujaFlecha( linea.getX1(), linea.getY1(), linea.getX2(), linea.getY2(),
	// grosor, color );
	// }
	//
	// /** Dibuja una flecha en la ventana
	...
	// * @param color Color de la l�nea
	// */
	// public void dibujaFlecha( double x, double y, double x2, double y2, float
	// grosor, Color color ) {
	...
	// */
	// public void dibujaFlecha( double x, double y, double x2, double y2, float
	// grosor, Color color, int largoFl ) {
	// graphics.setColor( color );
	// graphics.setStroke( new BasicStroke( grosor ));
	// graphics.drawLine( (int)Math.round(x), (int)Math.round(y),
	// (int)Math.round(x2), (int)Math.round(y2) );
	// double angulo = Math.atan2( y2-y, x2-x ) + Math.PI;
	// double angulo1 = angulo - Math.PI / 10; // La flecha se forma rotando 1/10 de
	// Pi hacia los dos lados
	// double angulo2 = angulo + Math.PI / 10;
	// graphics.drawLine( (int)Math.round(x2), (int)Math.round(y2),
	// (int)Math.round(x2+largoFl*Math.cos(angulo1)),
	// (int)Math.round(y2+largoFl*Math.sin(angulo1)) );
	// graphics.drawLine( (int)Math.round(x2), (int)Math.round(y2),
	// (int)Math.round(x2+largoFl*Math.cos(angulo2)),
	// (int)Math.round(y2+largoFl*Math.sin(angulo2)) );
	// panel.repaint();
	// }
	//
	// /** Dibuja una l�nea azul en la ventana
	...
	// * @param grosor Grueso de la l�nea (en p�xels)
	// */
	// public void borraFlecha( double x, double y, double x2, double y2, float
	// grosor ) {
