	...
	public VentanaLogin(BaseDeDatos bd, FisicasNuevas f, boolean isModoLiga) {
		...
		tFNombre.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent arg0) {
				...
				try {
					is = new FileInputStream("src/user_properties/"+tFNombre.getText()+".properties"); //Carga de user_properties automaticamente la contrase�a si el usuario esta registrado
					prop.load(is);
