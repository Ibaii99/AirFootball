...
//		lblEqL.setIcon(iiResizeoL);
		...
		btnIniciarAmistoso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dispose();
				ventanaPartido partido = new ventanaPartido(new Equipo(equipoL, "AAA", 1, Color.BLACK), new Equipo(equipoV, "AAA",1,Color.black), new Pelota(getBackground(), "pelota", 1), false, true, true); // aquï¿½ meter quizï¿½ un
