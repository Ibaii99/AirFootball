	...
	public MenuAmistoso(int anchura, int altura) throws ClassNotFoundException, SQLException {
		...
		btnIniciarAmistoso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ventanaPartido partido = new ventanaPartido(equipoLocal, equipoVisitante, new Pelota(getBackground(), "pelota", 1), false, true, true, new FisicasNuevas()); // aquï¿½ meter quizï¿½ un
