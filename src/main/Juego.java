...
public class Juego {
	...
	public ventanaPartido v;	// la ventana se creara cuando se elijan los equipos con los que se va a jugar
	...
	private static void anyadirTodosLosEquipos(BaseDeDatos bd) {
		try {
			bd.anyadirEquipo(new Equipo("ALA", "Deportivo Alav�s", 0, Color.BLUE, new ImageIcon("iconos/equipos/ala.png"),
			...
			bd.anyadirEquipo(new Equipo("ATM", "Atl�tico de Madrid", 0, Color.RED, new ImageIcon("iconos/equipos/atl.png"),
			...
			bd.anyadirEquipo(
					new Equipo("DEP", "Deportivo de La Coru�a", 0, Color.BLUE, new ImageIcon("iconos/equipos/dep.png"),
			...
			bd.anyadirEquipo(new Equipo("LEG", "Legan�s", 0, Color.BLUE, new ImageIcon("iconos/equipos/leg.png"),
